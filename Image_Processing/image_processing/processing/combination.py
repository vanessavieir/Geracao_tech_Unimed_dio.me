# Vanessa Ferreira, 21 days octub | 1 author(Vanessa Ferreira)
...
def find_difference(image1,image2):
    assert image1.shape == image2.shape, " Specify 2 images width de same shape."
    ...
    def transfer_histogram(image1,image2):
        matched_image=match_histograms(image1,multichannel=True)
